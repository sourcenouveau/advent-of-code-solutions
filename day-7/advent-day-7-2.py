# Advent of Code Solutions: Day 7, part 2
...
def eval_wire(wire, circuit, signals = None):
    ...
    if circuit[wire].op == None:
        ...
        signals[wire] = eval_wire(circuit[wire].l, circuit, signals) & eval_wire(circuit[wire].r, circuit, signals)
...
add_connection(str(a) + ' -> b', circuit)
